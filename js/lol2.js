...
function flyToLocation(lat, lng, building, placeName, campus, isInterestPoint = false) {
    ...
    // Desactivar temporalmente los maxBounds
    ...
    const onMoveEnd = () => {
        if (isInterestPoint) {
            ...
            if (pinMarker) {
                ...
                // Desactivamos autoPan al abrir el popup
                pinMarker.openPopup({ autoPan: false });
            ...
            const animateMarkerAndPopup = () => {
                if (targetMarker._icon) {
                    ...
                    // Desactivamos autoPan para evitar que Leaflet busque layerPointToContainerPoint
                    targetMarker.openPopup({ autoPan: false });
        ...
        // Restaurar los maxBounds de forma segura despues de abrir el popup
        setTimeout(() => {
    ...
    // Respaldo de seguridad en caso de que la animacion no dispare moveend
    setTimeout(() => {
        if (isFlying) {
