...
function flyToLocation(lat, lng, building, placeName, isInterestPoint = false) {
    ...
    map.once('moveend', () => {
        if (isInterestPoint) {
            ...
            if (!markerGroup) {
                console.log(`flyToLocation: No marker group found for building ${building}`);
                isFlying = false;
                return;
            }
            ...
            if (!targetMarker) {
                console.log(`flyToLocation: No target marker found at [${lat}, ${lng}] for building ${building}`);
                isFlying = false;
                return;
            }
...
function showLocationDetails(building, placeName, faculty, photos, comments) {
    console.log('showLocationDetails called with:', { building, placeName, faculty, photos, comments });
    ...
    const photoHTML = safePhotos.length > 0
        ? safePhotos
            ...
            .join('')
        : '<p>Imagenes y videos muy pronto, si quieres probarlas ve a puntos de interes o edificios c-1 de la Facultad de ciencias de la informacion y C de el area de Centro de idiomas.</p>';
...
function createInterestPointMarker(lat, lng, title, building, photos, comments) {
    ...
    marker.on('click', (e) => {
        console.log(`marcador ${title} en [${lat}, ${lng}]`);
...
function createInterestPinMarker(lat, lng, title, building) {
    ...
    try {
        ...
        console.log(`createInterestPinMarker: Error creating pin for ${title}:`, error);
        return null;
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!mapElement) {
        console.log('DOMContentLoaded: #map element not found');
        return;
    }
    ...
    function createMarker(lat, lng, title, building, iconConfig, faculty, photos, comments, isShared = false) {
        ...
        marker.on('click', () => {
            console.log(`marcador ${title} (de: ${building}) en [${lat}, ${lng}]`);
        ...
        marker.on('popupopen', () => {
            ...
            if (popupElement) {
                ...
                popupElement.addEventListener('click', (e) => {
                    console.log(`Popup clicked for ${title} (building: ${building})`);
                    e.stopPropagation();
                    if (isShared) {
    ...
    const locations = {
        ...
        'Edificio de Vinculacion': {
            places: [{
                ...
                comments: [
                    'Edificio de la facultad de Vinculacion',
                ]
            }],
        ...
        'Facultad de Quimica': {
            places: [
                ...
                comments: [
                    'Edificio de la facultad de quimica',
                ] },
        ...
        'Facultad de Ciencias Educativas': {
            places: [
                ...
                comments: [
                    'Edificio de la facultad de Ciencias Educativas',
                ] },
        ...
        'Facultad de Ciencias Economicas Administrativas': {
            places: [
                ...
                comments: [
                    'Edificio de la Ciencias Economicas Administrativas',
                ] },
                { name: 'S', coords: [760, 1333], icon: { iconUrl: '../image/pines/pin-fcea-s.svg', color: 'azul' } ,
                comments: [
                    'Edificio de la facultad de Ciencias Economicas Administrativas',
                ] },
    ...
    const interestPoints = [
        {
            ...
            coords: [861, 995],
            photos: [
                { url: '../image/galeria/areas-interes/CU/1.jpg', isPanoramic: true }
            ],
        ...
        },
        {
            ...
            coords: [660, 683],
            photos: [
                { url: '../image/galeria/areas-interes/b/2.jpg', isPanoramic: false }
            ],
        ...
        },
        {
            ...
            coords: [590, 1545],
            photos: [
                { url: '../image/galeria/areas-interes/MF/2.jpg', isPanoramic: false}
            ],
            comments: 'Área ideal para deportes, como futbol, voleibol.'
        }
    ];
