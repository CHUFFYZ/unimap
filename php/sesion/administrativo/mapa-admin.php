...
<body>
    ...
    <div class="supercontainer">
        <div class="usuario" id="usuario-toggle">
            <img src="../../../image/desarrolladores/alan.png" alt="User Image">
        </div>
