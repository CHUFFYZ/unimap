...
<body>
    <header class="welcome-header">
        ...
        <div class="log">
            <a id="logoweb" class="fl" href="mod-elim-prof.php"><img src="../../../image/iconos/logo/unimap.webp" alt="Logo Universidad"></a>
        </div>
    </header>

    <div class="container">
        <div class="section">
            <a href="alta-prof.php" class="btn-secondary"><i class="fas fa-arrow-left"></i> Regresar</a>
        </div>
        ...
        <div class="section">
            ...
            <!-- Baja Individual -->
            <form id="deleteForm" method="POST" action="../../back-end/prof-gest/eliminar/eliminar-prof.php" class="excel-form">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="../../back-end/prof-gest/eliminar/confirmar-eliminar-prof.php">
    ...
    <script>
        ...
        function confirmBulkDelete() {
            ...
            if (confirm('¿Está seguro de eliminar los profesores seleccionados?')) {
                ...
                form.method = 'POST';
                form.action = '../../back-end/prof-gest/eliminar/eliminar-prof-masivo.php';
        ...
        function saveModifications(row) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '../../back-end/prof-gest/modificar/modificar-prof.php';
            const input = document.createElement('input');
            input.type = 'hidden';
            input.name = 'profesor';
