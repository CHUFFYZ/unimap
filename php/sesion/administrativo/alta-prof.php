...
<body>
    <header class="welcome-header">
        ...
        <div class="log">
            <a id="logoweb" class="fl" href="alta-prof.php"><img src="../../../image/iconos/logo/unimap.webp" alt="Logo Universidad"></a>
        </div>
    </header>
    ...
    <div class="container">
        <div class="section">
            ...
            <a href="mod-elim-prof.php" class="btn-primary"><i class="fas fa-user-plus"></i> Modificar-Eliminar Profesores</a>
        </div>
        ...
        <div class="section">
            ...
            <!-- Alta Individual -->
            <form id="studentForm" method="POST" action="../../back-end/prof-gest/registrar/registrar-prof.php" class="excel-form">
            ...
            <!-- Alta Masiva -->
            <div class="excel">
                <form method="POST" action="../../back-end/prof-gest/registrar/registrar-prof-masivo.php" enctype="multipart/form-data" class="excel-form">
