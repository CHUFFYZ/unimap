...
<body>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <a href="gestion-alumnos.php" class="btn-primary"><i class="fas fa-user-plus"></i> Modificar-Eliminar Alumnos</a>
        </div>
        ...
        <div class="section">
            ...
            <!-- Alta Individual -->
            <form id="studentForm" method="POST" action="backend/registrar-alumn.php" class="excel-form">
            ...
            <!-- Alta Masiva -->
            <div class="excel">
                <form method="POST" action="backend/registrar-masivo.php" enctype="multipart/form-data" class="excel-form">
