...
<header>
    <div class="supercontainer">
        <div class="containerlogo">
            <a id="logoweb" class="fl" href="mapaADMIN.php"><img src="../image/LogoBlanco.webp" alt="LogoUnimap"></a>
        </div>
        ...
        <div class="menu-container" id="menu-container">
            <div class="containerinf1">
                <div id="top-nav2" class="clearfix">
                    <nav class="fr2">
                        <a class="btn" href="acciones-admin/gestion-afis.php">Gestion Afis</a>
                    </nav>
                </div>
            </div>
